...
function login(){
	document.addEventListener('DOMContentLoaded', function () {
		...
		loginForm.addEventListener('submit', function (e) {
			...
			const loginSukses = akun.some(akun => akun.user === username && akun.pass === password);

			if (loginSukses) {
				alert('Login berhasil!');
				window.location.href = 'dashboard.html'; // Redirect ke halaman dashboard setelah login berhasil
			}
			else {
